package grimhart.aota.client.gui;
...
public class GuiTrading extends GuiContainer {
    ...
    public GuiTrading(InventoryPlayer inventoryPlayer, IMerchant merchant, World worldIn) {
        super(new ContainerTrading(inventoryPlayer, merchant, worldIn));
    ...
    protected void actionPerformed(GuiButton button) throws IOException {
        ...
        if (flag) {
            ((ContainerTrading) this.inventorySlots).setCurrentRecipeIndex(this.selectedMerchantRecipe);
            PacketDispatcher.sendToServer(new TradeSelectionMessage(this.selectedMerchantRecipe));
        }
    }
